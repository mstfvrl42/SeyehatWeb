    ...
    <div class="row">
      <div class="col-lg-8 mb-5 mb-lg-0">
                    <div class="blog_left_sidebar">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:dbGoTripConnectionString %>" SelectCommand="SELECT * FROM [tblBlog] inner join tblBlogKategori.id=tblBlog.KategoriId"></asp:SqlDataSource>
                        <asp:DataList ID="DataList1" runat="server" DataKeyField="id" DataSourceID="SqlDataSource2">
                            <ItemTemplate>
                                   <article class="blog_item">
                            <div class="blog_item_img">
                                <img class="card-img rounded-0" src='image/Blog/<%# Eval("Resim") %>' alt='<%# Eval("adi") %>''>
