<%@ Page Title="" Language="C#" MasterPageFile="~/Yönetim/Admin.Master" AutoEventWireup="true" CodeBehind="BlogDüzenleSecilen.aspx.cs" Inherits="SeyehatWeb.Yönetim.BlogDüzenleSecilen" %>
                ...
                <div class="card-body">
                  ...
                  <div class="forms-sample" >
                    ...
                    <div class="form-group">
                      ...
                      <input type="file" name="img[]" class="file-upload-default">
                       ...
                       <asp:FileUpload ID="FileUpload1" runat="server" CssClass="form-control file-upload-info" />
                        <asp:Button ID="Button2" runat="server" Text="Resim Yükle" CssClass="btn btn-gradient-primary me-2px" OnClick="Button2_Click" />
                    </div>
                    ...
                    <div class="form-group">
                     ...
                     <asp:Button ID="Button3" runat="server" Text="Yükle" CssClass="btn btn-gradient-primary me-2px" OnClick="Button3_Click" />
                      <asp:Button ID="Button1" runat="server" Text="Güncelle" CssClass="btn btn-gradient-primary me-2px" OnClick="Button1_Click" />
